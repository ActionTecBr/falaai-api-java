...
public class HealthApi {
    ...
    /**
     * Build call for healthCheckHead
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call healthCheckHeadCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call healthCheckHeadValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return healthCheckHeadCall(_callback);
     ...
     */
    public HealthResponse healthCheckHead() throws ApiException {
        ApiResponse<HealthResponse> localVarResp = healthCheckHeadWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<HealthResponse> healthCheckHeadWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = healthCheckHeadValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<HealthResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call healthCheckHeadAsync(final ApiCallback<HealthResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = healthCheckHeadValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<HealthResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
