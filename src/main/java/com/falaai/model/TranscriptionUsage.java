...
public class TranscriptionUsage {
  ...
  public boolean equals(Object o) {
    ...
    TranscriptionUsage transcriptionUsage = (TranscriptionUsage) o;
    return Objects.equals(this.audioSeconds, transcriptionUsage.audioSeconds) &&
        Objects.equals(this.creditsConsumed, transcriptionUsage.creditsConsumed) &&
        Objects.equals(this.processingMs, transcriptionUsage.processingMs);
  }

  @Override
  public int hashCode() {
    return Objects.hash(audioSeconds, creditsConsumed, processingMs);
  }
  ...
  public String toString() {
    ...
    sb.append("    audioSeconds: ").append(toIndentedString(audioSeconds)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("audio_seconds", "credits_consumed", "processing_ms"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("audio_seconds", "credits_consumed", "processing_ms"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TranscriptionUsage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TranscriptionUsage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TranscriptionUsage is not found in the empty JSON string", TranscriptionUsage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TranscriptionUsage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TranscriptionUsage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TranscriptionUsage.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TranscriptionUsage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TranscriptionUsage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TranscriptionUsage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TranscriptionUsage.class));

       return (TypeAdapter<T>) new TypeAdapter<TranscriptionUsage>() {
           @Override
           public void write(JsonWriter out, TranscriptionUsage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TranscriptionUsage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TranscriptionUsage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TranscriptionUsage
   * @throws IOException if the JSON string is invalid with respect to TranscriptionUsage
   */
  public static TranscriptionUsage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TranscriptionUsage.class);
  }

  /**
   * Convert an instance of TranscriptionUsage to an JSON string
   *
   * @return JSON string
   */
