...
public class DiagnosticTextAnalysis {
  ...
  public boolean equals(Object o) {
    ...
    DiagnosticTextAnalysis diagnosticTextAnalysis = (DiagnosticTextAnalysis) o;
    return Objects.equals(this.explanation, diagnosticTextAnalysis.explanation);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("explanation"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to DiagnosticTextAnalysis
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DiagnosticTextAnalysis.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DiagnosticTextAnalysis is not found in the empty JSON string", DiagnosticTextAnalysis.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DiagnosticTextAnalysis.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DiagnosticTextAnalysis` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DiagnosticTextAnalysis.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DiagnosticTextAnalysis' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DiagnosticTextAnalysis> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DiagnosticTextAnalysis.class));

       return (TypeAdapter<T>) new TypeAdapter<DiagnosticTextAnalysis>() {
           @Override
           public void write(JsonWriter out, DiagnosticTextAnalysis value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DiagnosticTextAnalysis read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DiagnosticTextAnalysis given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DiagnosticTextAnalysis
   * @throws IOException if the JSON string is invalid with respect to DiagnosticTextAnalysis
   */
  public static DiagnosticTextAnalysis fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DiagnosticTextAnalysis.class);
  }

  /**
   * Convert an instance of DiagnosticTextAnalysis to an JSON string
   *
   * @return JSON string
   */
