...
/**
 * Gets or Sets EmailEvent
 */
@JsonAdapter(EmailEvent.Adapter.class)
public enum EmailEvent {
  ...
  public static EmailEvent fromValue(String value) {
    for (EmailEvent b : EmailEvent.values()) {
  ...
  public static class Adapter extends TypeAdapter<EmailEvent> {
    @Override
    public void write(final JsonWriter jsonWriter, final EmailEvent enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EmailEvent read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EmailEvent.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EmailEvent.fromValue(value);
  }
}
