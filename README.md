# FalaAI API Java SDK - Speech-to-Text, Call Analytics & Compliance Audit

[![version](https://img.shields.io/maven-central/v/io.github.actiontecbr/falaai-api)](https://central.sonatype.com/artifact/io.github.actiontecbr/falaai-api)
...
Official Java SDK for the **FalaAI API** - call transcription, conversation intelligence and compliance auditing (**COPC CX**, **ISO 18295-1**).
